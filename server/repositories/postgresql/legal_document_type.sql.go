...
func (q *Queries) FindLegalDocTypeByID(ctx context.Context, dollar_1 pgtype.Text) (FindLegalDocTypeByIDRow, error) {
	row := q.db.QueryRow(ctx, findLegalDocTypeByID, dollar_1)
