...
func (q *Queries) FindSubdistrictByID(ctx context.Context, dollar_1 pgtype.Text) (FindSubdistrictByIDRow, error) {
	row := q.db.QueryRow(ctx, findSubdistrictByID, dollar_1)
